/*
Solution from https://github.com/AJSKirk/aoc/blob/master/c/2020/day01.c
*/
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc, char* argv[]) {
	...
	printf("The product of two matching entries is: %i\n", twosum(expenses, len, GLOBAL_TARGET));
	printf("The product of three matching entries is: %i\n", threesum(expenses, len, GLOBAL_TARGET));
